...
UNIT_TESTS := test_ops test_cache test_st test_cfg test_tok test_dsv4_config test_dsv4_inventory test_dsv4_cpu_ops test_dsv4_attention_state test_dsv4_attention_numeric test_dsv4_sparse_index test_dsv4_attention_step test_dsv4_attention_runtime test_dsv4_moe test_dsv4_decoder_layer test_dsv4_model test_dsv4_mtp scale_test k3_model
...
$(BIN)/test_dsv4_model: tests/unit/test_dsv4_model.c src/cpu/dsv4_model.c src/cpu/dsv4_decoder_layer.c src/cpu/dsv4_attention_runtime.c src/cpu/dsv4_attention_step.c src/cpu/dsv4_attention_numeric.c src/cpu/dsv4_attention_state.c src/cpu/dsv4_sparse_index.c src/cpu/dsv4_moe.c src/cpu/dsv4_cpu_ops.c include/dsv4/dsv4_model.h include/dsv4/dsv4_decoder_layer.h include/dsv4/dsv4_attention_runtime.h include/dsv4/dsv4_attention_step.h include/dsv4/dsv4_attention_numeric.h include/dsv4/dsv4_attention_state.h include/dsv4/dsv4_sparse_index.h include/dsv4/dsv4_moe.h include/dsv4/dsv4_cpu_ops.h tests/fixtures/dsv4_model_shell_vectors.h | $(BIN)
	$(CC) -O2 -std=c99 $(WARN) -Werror -ffp-contract=off -Iinclude/dsv4 -Itests/fixtures tests/unit/test_dsv4_model.c src/cpu/dsv4_model.c src/cpu/dsv4_decoder_layer.c src/cpu/dsv4_attention_runtime.c src/cpu/dsv4_attention_step.c src/cpu/dsv4_attention_numeric.c src/cpu/dsv4_attention_state.c src/cpu/dsv4_sparse_index.c src/cpu/dsv4_moe.c src/cpu/dsv4_cpu_ops.c -o $@ -lm

$(BIN)/test_dsv4_mtp: tests/unit/test_dsv4_mtp.c src/cpu/dsv4_mtp.c src/cpu/dsv4_decoder_layer.c src/cpu/dsv4_attention_runtime.c src/cpu/dsv4_attention_step.c src/cpu/dsv4_attention_numeric.c src/cpu/dsv4_attention_state.c src/cpu/dsv4_sparse_index.c src/cpu/dsv4_moe.c src/cpu/dsv4_cpu_ops.c include/dsv4/dsv4_mtp.h include/dsv4/dsv4_decoder_layer.h include/dsv4/dsv4_attention_runtime.h include/dsv4/dsv4_attention_step.h include/dsv4/dsv4_attention_numeric.h include/dsv4/dsv4_attention_state.h include/dsv4/dsv4_sparse_index.h include/dsv4/dsv4_moe.h include/dsv4/dsv4_cpu_ops.h tests/fixtures/dsv4_mtp_vectors.h tests/fixtures/dsv4_model_shell_vectors.h | $(BIN)
...
test-dsv4-model: $(BIN)/test_dsv4_model
	$(BIN)/test_dsv4_model
...
test: $(TEST_BINS) $(BIN)/dsv4-inspect $(BIN)/dsv4-inventory
	...
	@echo "== DeepSeek base model =="; $(MAKE) --no-print-directory test-dsv4-model
